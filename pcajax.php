...
<?php
if(isset($_GET['faculty_id_id'])){
  $faculty=$_GET['faculty_id_id'];
  ...
  if($faculty!=""){
    ...
    if($res){
      ...
      if($count>=1){
        echo '<div class="form-group">';
        echo '<select name="department" class="form-control" onChange="change_department_id()" id="departmentlist_id">';
        echo '<option value="">Select The Departmen here</option>';
        while($row=mysqli_fetch_assoc($res)){
          echo "<option value='$row[department]'>"; echo $row["department"];  echo " </option>";
        }
...
<?php
if(isset($_GET['faculty_id_id_not'])){
  $faculty=$_GET['faculty_id_id_not'];
...
<?php
if(isset($_GET['faculty_id_recreate'])){
  $faculty=$_GET['faculty_id_recreate'];
  ...
  if($faculty!=""){
    ...
    if($res){
      ...
      if($count>=1){
        echo '<div class="form-group">';
        echo '<select name="department" class="form-control" onChange="change_department_id_recreate()" id="departmentlist_id_recreate">';
        echo '<option value="">Select The Departmen here</option>';
        while($row=mysqli_fetch_assoc($res)){
          echo "<option value='$row[department]'>"; echo $row["department"];  echo " </option>";
        }
